...
exports.title = 'Build Ti SDK from source';
exports.desc = 'Build any version and platform of Titanium(R) sdk from source';
/**
...
exports.run = function(logger, config, cli, finished) {
    ...
    if (['all','android', 'ios', 'windows'].indexOf(platform) === -1) {
